...
const ModeWrapper = memo(function ModeWrapper({
  ...
  useEffect(() => {
    const geo = nodes[geometryKey]?.geometry || Object.values(nodes)[0]?.geometry;
...
function Lens({ modeProps, ...p }) {
  return <ModeWrapper glb="/assets/3d/lens.glb" geometryKey="DamagedHelmet" followPointer modeProps={modeProps} {...p} />;
}
